...
header("Content-Disposition: attachment; filename=Siparisler_" . date('Ymd') . ".xls");
...
try {
    ...
    $query = "SELECT id, siparis_tarihi, hangisayfa, musteri_ismi, musteri_telefonu, musteri_adresi, musteri_il, musteri_ilce, urunler, odeme_sarti, hangikargo, kargo_barkodu 
              FROM siparisler 
              WHERE exceldurum = 0";
